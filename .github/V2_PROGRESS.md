...
6.  copy `src/components/__tests__/__template__-test.js` into your own test and edit to fit your usage
...
10. Add docs in `docs/src/components/{name}.md`
11. if it's a new component, also add it in `src/instantsearch.js` (three times)
12. ...
13. Profit!
